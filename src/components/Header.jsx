...
const Header = () => {
  return (
    <div className="flex  h-[80px]">
      ...
      <img  className="h-[40px]"src={myntralogo}></img>
      ...
      <div className="w-[50%] flex flex-row items-center">
        ...
        <div className="px-[10px] cursor-pointer">
          <a className='font-bold'>STUIDO</a>
          </div>
      </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
        ...
        <input  className = "h-[50%] w-[100%] bg-[#F5F5F6] rounded pl-[40px] focus:bg-white focus:outline-none focus:border-[2px]" type='text' placeholder='Search for Products, Brands & more'></input>
      </div>
      <div className="w-[15%] flex flex-row  justify-center items-center">
        <div className='flex-1 flex flex-col'> 
          <div className='flex justify-center'>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className='w-5 h-5 stroke-1'>
